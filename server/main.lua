...
local function setPlayerStatus(xPlayer, data)
	...
	TriggerClientEvent('joker_sts:load', xPlayer.source, data)
end
...
AddEventHandler('joker_sts:getStatus', function(playerId, statusName, cb)
...
RegisterServerEvent('joker_sts:update')
AddEventHandler('joker_sts:update', function(status)
